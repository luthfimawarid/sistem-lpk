                ...
                <table class="min-w-full text-sm md:text-base">
                    <thead>
                        <tr class="text-gray-600 bg-blue-50">
                            ...
                            <th class="py-3 px-4 text-left whitespace-nowrap">Nilai Akhir</th>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            @php
                                $warnaKelas = 'text-gray-700';
                                if ($item['prediksi'] == 'Lulus') {
                                    $warnaKelas = 'text-green-600';
                                } elseif ($item['prediksi'] == 'Beresiko') {
                                    $warnaKelas = 'text-yellow-600';
                                } elseif ($item['prediksi'] == 'Tidak Lulus') {
                                    $warnaKelas = 'text-red-600';
                                }
                            @endphp
                            <tr class="border-t">
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }}">{{ $item['nama'] }}</td>
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }}">{{ $item['kelas'] }}</td>
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }}">{{ $item['bidang'] }}</td>
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }}">{{ $item['nilai_tugas'] }}</td>
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }}">{{ $item['nilai_evaluasi'] }}</td>
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }}">{{ $item['nilai_tryout'] }}</td>
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }}">
                                ...
                                <td class="py-3 px-4 whitespace-nowrap {{ $warnaKelas }} font-medium">
                                    {{ $item['prediksi'] }}
                                </td>
