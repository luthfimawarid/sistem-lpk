...
<main class="p-6 my-4">
    <form class="bg-white p-6 rounded-lg shadow-md" action="#" method="POST" enctype="multipart/form-data">
        <h1 class="text-xl font-semibold mb-10">Edit E-book</h1>
        <div class="my-6">
            <input type="text" id="judul" name="judul" class="mt-1 block w-full border-b py-1 text-sm border-gray-200 focus:ring-blue-500 focus:border-blue-500" required placeholder="masukan nama e-book">
        </div>
