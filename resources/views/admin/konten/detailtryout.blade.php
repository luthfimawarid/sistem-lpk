...
<div class="p-10 bg-blue-50">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-xl font-semibold">Detail Tryout: {{ $tugas->judul }}</h1>
        ...
        @if ($tugas->durasi)
            <p class="mb-1"><strong>Durasi Tryout:</strong> {{ $tugas->durasi }} menit</p>
        @endif

        @if ($tugas->cover)
            <p class="mb-1"><strong>File Tryout:</strong>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        <h3 class="text-lg font-semibold mb-4">Peserta Tryout</h3>
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm border">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-4 py-2 text-center text-gray-500">Belum ada peserta.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
