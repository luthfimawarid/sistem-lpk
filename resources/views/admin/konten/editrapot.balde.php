...
<div class="p-10 bg-blue-50">
    <div class="header flex justify-between items-center pb-6">
        <h1 class="text-xl font-semibold">Edit Nilai Rapot</h1>
    ...
    <main class="min-h-screen bg-gray-100">
        <form action="#" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            <div class="mb-4">
                <label for="judul" class="block text-sm font-medium text-gray-700">Judul Nilai Rapt</label>
                <input type="text" id="judul" name="judul" class="mt-1 p-2 w-full border rounded-md" placeholder="Masukkan judul Nilai Rapt">
            </div>
            <div class="mb-4">
                <label for="deskripsi" class="block text-sm font-medium text-gray-700">Deskripsi</label>
                <textarea id="deskripsi" name="deskripsi" rows="4" class="mt-1 p-2 w-full border rounded-md" placeholder="Masukkan deskripsi Nilai Rapt"></textarea>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <select id="tipe" name="tipe" class="mt-1 p-2 w-full border rounded-md">
                    <option value="Nilai Rapt">Nilai Rapt</option>
                    <option value="Nilai Rapt">Nilai Rapt</option>
