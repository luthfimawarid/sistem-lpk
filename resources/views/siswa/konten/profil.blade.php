...
<main class="p-6 bg-[#F2F8FF] min-h-screen">
    <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div id="tab-data-diri" class="tab-content">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="Alamsyah" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">NISN</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="1234567890" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">Email</label>
                    <input type="email" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="alamsyah@email.com" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">No HP</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="081234567890" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">Kelas</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="Kelas A" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">Status</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="Aktif" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">Angkatan</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="2023" readonly>
                </div>
            </div>
        </div>
        ...
        <div id="tab-nilai" class="tab-content hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="text-gray-500 text-sm">Rata-rata Nilai Bahasa</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="84" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">Rata-rata Nilai Budaya</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="80" readonly>
                </div>

                <div>
                    <label class="text-gray-500 text-sm">Nilai Akhir</label>
                    <input type="text" class="w-full border-b border-gray-300 p-1 text-sm outline-none bg-transparent" value="82" readonly>
                </div>
