    ...
    <div class="bg-white p-4 sm:p-6 rounded shadow">
        ...
        @if (!$punyaNilaiEvaluasi)
            <p class="text-gray-500 text-sm mb-4">
                Kamu belum memiliki nilai evaluasi mingguan, lowongan ini akan muncul setelah ada nilai evaluasi.
            </p>
        @elseif ($jobTanpaSertifikat->isEmpty())
            <p class="text-gray-500 text-sm mb-4">
                Tidak ada lowongan yang tersedia tanpa sertifikat.
            </p>
        @else
